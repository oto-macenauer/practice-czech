  ...
  sections: [
    // ===== 1. Tvrdé a měkké souhlásky – psaní i/í, y/ý =====
    {
      ...
      items: [
        ...
        { before: "t", after: "kat", choices: ["i", "y"], correct: "y" },
        { before: "čern", after: "", choices: ["í", "ý"], correct: "ý" },
        { before: "dob", after: "tek", choices: ["í", "ý"], correct: "ý" },
        { before: "h", after: "popotam", choices: ["i", "y"], correct: "y" },
        ...
        { before: "č", after: "st", choices: ["i", "y"], correct: "i" },
        { before: "č", after: "tatel", choices: ["i", "y"], correct: "i" },
        ...
        { before: "ř", after: "dítko", choices: ["í", "ý"], correct: "í" },
        { before: "ř", after: "pa", choices: ["í", "ý"], correct: "í" },
